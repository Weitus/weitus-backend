    ...
    public class JwtService
    {
        ...
        public Claim[] CreateClaims(WeitusUser user) =>
            new[] {
                ...
                new Claim(ClaimTypes.Email, user.GetDecryptedEmail(
                    Convert.FromHexString(_configuration["Encryption:Key"]),
                    Convert.FromHexString(_configuration["Encryption:IV"])))
            };
